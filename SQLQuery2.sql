...
---UC3-- Create employee_payroll data as part of CRUD Operation--
...
select salary from employee_payroll where Name = 'Kavya' ;
select * from employee_payroll where StartDate between cast ('2020-08-02' as date) and GETDATE();
...
insert into employee_payroll (Name, salary, StartDate, Gender, Phone, Address, Department, Basic_Pay, Deduction, Taxable_Pay, Income_Tax)
							values ('Kavya', 500000, '2020-08-02', 'F', 1234567890, 'Pune', 'IT', 500000, 10000, 2000, 1500);
update employee_payroll set Net_Pay = (Basic_Pay-Deduction-Taxable_Pay-Income_Tax);
